...
public Document getDocument(LatLng start, LatLng end, String mode) {
    ...
    try {
        ...
        // DocumentBuilder-Defines the API to obtain DOM Document instances from an XML document. Using this class, an application  can obtain a Document from XML.
        ...
        for (int i = 0; i < nl1.getLength(); i++) {
           ...
           ////////////////////start_location//////////////////////////////////
            ...
            for (int j = 0; j < arrPoly.size(); j++) {
                listOfGeopoints.add(new LatLng(arrPoly.get(j).latitude, arrPoly.get(j).longitude));
            }
           //////////////////////////////////////////////////////////////
